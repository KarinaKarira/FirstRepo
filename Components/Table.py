...
class SimpleTable(VerticalScrolledFrame):
    def __init__(self, parent, rows=10, columns=5,**kwargs):
        ...
        # self.header_color="#63615b"
        self.header_color='ivory'
        ...
        for row in range(rows):
            ...
            for column in range(columns):
                label = Label(self, text="-",borderwidth=0, height=3,bg=bg,wraplength=400,width=40)
...
if __name__ == "__main__":
    root = Tk()
    t = SimpleTable(root, rows=10, columns=2,width=200)
